...
Based on: personal pension **£3,600 gross/year** for **12 years** (age 53→65), starting
pot **£0**, charges **0.5%/year**, medium risk, plus Janey's confirmed **Teachers'
Pension** and the **State Pension**. **Illustrative, not guarantees.**

## Personal pension pot at retirement (age 65)

| Scenario | Net growth | Pot at 65 (future money) | ≈ today's money |
|----------|-----------|--------------------------|-----------------|
| Cautious | 2.5% | £50,900 | ~£37,900 |
| **Central** | **4.5%** | **£58,200** | **~£43,300** |
| Optimistic | 6.5% | £66,600 | ~£49,500 |

*Central pot: £43,200 contributions + ~£15,000 growth. Gives £14,500 tax-free cash and
~£2,300/year drawdown (~4%).*

## Janey's total annual income

The personal pension is now the *smallest* of Janey's three income sources — the
Teachers' Pension and State Pension do the heavy lifting.

| Component | Age 60–64 | Age 65–66 | Age 67+ |
|-----------|-----------|-----------|---------|
...
lump sum available from 60.*

## What this tells us

1. **The income bridge is largely solved.** With £6,982/year (index-linked) available
...
4. **A timing decision to make:** when to take the Teachers' 80th pension (age 60
   unreduced is the natural point) and the lump sum, relative to stopping work at 65 and
   the State Pension at 67.
